...
public class AsistenciaJpaController implements Serializable {
    ...
    public void create(Asistencia asistencia) {
        ...
        try {
            ...
            Inscripciones inscripcionId = asistencia.getInscripcionId();
            ...
            if (inscripcionId != null) {
                inscripcionId.getAsistenciaCollection().add(asistencia);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Inscripciones inscripcionId = asistencia.getInscripcionId();
            if (inscripcionId != null) {
                inscripcionId.getAsistenciaCollection().remove(asistencia);
                inscripcionId = em.merge(inscripcionId);
            }
